<pre>
Evaluation of the Cloud Biometric API Facial Recognition Algorithm using Diversity in Faces <br>
Fair Evaluation Dataset (DIF-CELEB-1M). The Cloud Biometric API Facial Recognition Model 1607349233 <br>
